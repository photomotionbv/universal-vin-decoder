...
export enum manufacturers {
  ...
  '6T1' = 'Toyota',
  '6T9' = 'Trailer',
  '6U9' = 'Low Volume (Grey) Import Vehicles which don\'t have 17 Digit VIN. Uses NON ISO VIN with "Filler 0\'s between WMI & Non Iso VIN - I.e Japanese VIN PV35-400637 would become 6U90000PV35400637',
